...
class Model:
    ...
    def train(self, callbacks: DefaultDict[str, List[Callable]], **kwargs):
        ...
        for epoch in range(args.start_epoch, args.epochs):
            ...
            eval_interval = max(1, int(getattr(args, "eval_interval", 1)))
            ...
            if should_eval:
                ...
                logger.info("Skipping validation at epoch %d (eval_interval=%d)", epoch, eval_interval)
...
def get_args_parser():
    ...
    parser.add_argument('--matcher_chunk_size', default=0, type=int,
                        help="Chunk size for matcher cost computation rows. 0 disables chunking.")
