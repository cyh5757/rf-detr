...
# -*- coding: utf-8 -*-
"""
RF-DETR Segmentation Training Script (cell_opti_10) - v6 (strict query-only tuning)
...
def parse_args() -> TrainConfig:
    p = argparse.ArgumentParser(description="RF-DETR Segmentation training (cell_opti_10) - v6 strict query-only")
...
def main():
    ...
    print("====================================================")
    print("[INFO] RF-DETR Seg Training Start (v6 strict query-only)")
